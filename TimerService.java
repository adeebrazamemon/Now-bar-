...
public class TimerService extends Service {
    ...
    private Notification build() {
        ...
        // Android 16+ promoted ongoing notifications are the standard Live Updates
        // path used by system surfaces such as the Samsung Now Bar on One UI 8.
        // NotificationCompat 1.17.0 exposes this without requiring API 36 calls in
        // our Java source, while older Android versions simply treat it as a normal
        // ongoing foreground-service notification.
        b.setRequestPromotedOngoing(true);

        // Keep the raw extra as a compatibility fallback for builds/devices where
        // the framework understands the key but the compat API is not the mechanism
        // used internally.
